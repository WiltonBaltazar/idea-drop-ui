  ...
  return (
    <header className='bg-white shadow'>
      <div className='container mx-auto px-6 py-4 flex justify-between items-center'>
        ...
        {/* Auth Buttons */}
        <div className='flex items-center sapce-x2'>
          {
            !user ? (
              <>
                <Link
                ...
                <Link
                  to='/register'
                  className='bg-gray-100 hover:bg-gray-200 hover:text-gray-800 font-medium transition px-4 py-2 rounded-md leading-none'
                >
                  Register
                </Link>
              </>
              ...
              <>
                ...
                <button
                  ...
                  className='text-red-600 hover:text-red-900 font-medium transition px-3 py-2 rounded-md leading-none'
                >
                  Logout
                </button>
              </>
