    ...
    return (
        <div className='sapce-y-6'>
            <div className="flex justify-between items-center mb-4">
                <h1 className="text-2xl font-bold text-gray-800">Edit Idea</h1>
                <Link to='/ideas/$ideaId'
                    params={{ ideaId }}

                    className="bg-blue-600 hover:bg-blue-700 text-white font-medium transition px-4 py-2 rounded-md leading-none">Back to Idea</Link>
            </div>
